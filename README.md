...
HPatches view split was generated via the script HPatchesDatasetCreator.py. You need to download hpatches-release folder, run the script and then you should get the exactly same file.
