...
HPatches view split pt file was generated via the script HPatchesDatasetCreator.py. If you want to create it yourself (you can generate illum split as well), you need to download hpatches-release folder, run the script and then you should get the exactly same file.
